        ...
        <div id="mainMenu">
            <div class="wrap">
                ...
                <ul class="pages" @click="closeMenu()">
                    <li @mouseover="changeBackground($event)" @mouseout="getActivePage()"><nuxt-link :to="{name: 'Index'}" title="Go to the Index page">Home</nuxt-link></li>
                    <li @mouseover="changeBackground($event)" @mouseout="getActivePage()"><nuxt-link :to="{name: 'Dates'}" title="Go to the Tour Dates page">Tour Dates</nuxt-link></li>
                    <li @mouseover="changeBackground($event)" @mouseout="getActivePage()"><nuxt-link  :to="{name: 'Tv'}" title="Go to the Vlog page">Bastards Television</nuxt-link></li>
                    <li @mouseover="changeBackground($event)" @mouseout="getActivePage()"><nuxt-link :to="{name: 'News'}" title="Go to the News page">News</nuxt-link></li>
                    ...
                    <li @mouseover="changeBackground($event)" @mouseout="getActivePage()"><nuxt-link :to="{name: 'About'}"  title="Go to the About page">About</nuxt-link></li>
                </ul>
            </div>
