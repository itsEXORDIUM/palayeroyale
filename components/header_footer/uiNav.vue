        ...
        <div id="mainMenu">
            <div class="wrap">
                ...
                <ul class="pages" @click="closeMenu()">
                    <li @mouseover="changeBackground($event)" @mouseout="getActivePage()"><nuxt-link to="/palayeroyale/index.html" title="Go to the Index page">Home</nuxt-link></li>
                    <li @mouseover="changeBackground($event)" @mouseout="getActivePage()"><nuxt-link to="/palayeroyale/tourDates/index.html" title="Go to the Tour Dates page">Tour Dates</nuxt-link></li>
                    <li @mouseover="changeBackground($event)" @mouseout="getActivePage()"><nuxt-link to="/palayeroyale/royalTelevision/index.html" title="Go to the Vlog page">Bastards Television</nuxt-link></li>
                    <li @mouseover="changeBackground($event)" @mouseout="getActivePage()"><nuxt-link to="/palayeroyale/news/index.html" title="Go to the News page">News</nuxt-link></li>
                    ...
                    <li @mouseover="changeBackground($event)" @mouseout="getActivePage()"><nuxt-link to="/palayeroyale/about/index.html"  title="Go to the About page">About</nuxt-link></li>
                </ul>
            </div>
